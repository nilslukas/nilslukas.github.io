...
(function () {
  ...
  var BIO = "Nils Lukas is an Assistant Professor of Machine Learning at MBZUAI in Abu Dhabi, where he leads the SPOT (Secure, Private, Open and Trustworthy) AI Lab. His research develops secure and private machine learning systems, with a focus on content watermarking, privacy-preserving inference, and AI safety and security. He holds a Ph.D. from the University of Waterloo — recognized with its Top Mathematics Doctoral Prize and Alumni Gold Medal — and his work appears at venues including ICML, ICLR, NeurIPS, IEEE S&P, and USENIX Security.";
